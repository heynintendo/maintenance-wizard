...
See [`PROJECT_DOCUMENTATION.md`](PROJECT_DOCUMENTATION.md) for the full system design and submission document: problem context, architecture, technology stack, data and system flow, model design and reasoning pipeline, alerting logic, coverage of the required outputs, worked examples, installation, and limitations.
